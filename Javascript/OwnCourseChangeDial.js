function OwnCourseChangeDial(TVReOffsetX, TVReOffsetY, dialCanvasContext, pointerCanvasContext)  {
        var angle1 = 0;
        var angle2 = 0;
        ...
        DialImg.src = "assets/img/ownCourseChangeDial.png";
        ...
        this.setAngle1 = function(angle)  {
            // angle given in degrees, in range (0;10)
            var convertedAngle;
            if(angle > 10)
                convertedAngle = angle % 10;
            else if(angle < 0)
                convertedAngle = -(10 - angle % 10);
            else
                convertedAngle = angle;
            convertedAngle = convertedAngle * 36;
