function SpreadAngleDial(TVReOffsetX, TVReOffsetY, dialCanvasContext, pointerCanvasContext)  {
        var angle1 = 0;
        var angle2 = 0;
        ...
        DialImg.src = "assets/img/spreadAngleDial.png";
        ...
        this.setAngle1 = function(angle)  {
            ...
            convertedAngle = convertedAngle * 9;
